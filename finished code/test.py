...
'''
This script performs spatial analysis on neural and positional data,
including data loading, processing, visualization, and prediction testing.
'''
...
DTYPE = np.int16
START_SAMPLE = int((3900.65-0.3)*POS_SAMPLING_RATE)
DURATION = 6000
...
tet_res, clu = data.get_tetrode_spike_times(f"data/{SESSION}/{SESSION}.clu", f"data/{SESSION}/{SESSION}.res", TETRODE_ID, POS_SAMPLING_RATE, RES_SAMPLING_RATE)
